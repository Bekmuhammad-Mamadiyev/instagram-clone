...
class Post(BaseModel):
    ...
    image = models.FileField(upload_to='post_images', validators=[
        FileExtensionValidator(allowed_extensions=['jpg', 'jpeg', 'png', 'mp4', 'avi', 'mov', 'mkv'])])
...
class PostComment(BaseModel):
    ...
    def __str__(self):
        return f"{self.author} ning {self.comment}"
